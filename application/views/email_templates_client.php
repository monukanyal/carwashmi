	...
	<?php include'template/sidebar.php'; ?>
		...
		<div class="app-content app-sidebar-left">
			...
			<div id="template1">
				...
				<div class="panel-heading">Client Email Template</div>
				  <div class="panel-body">
				  		<div class="form-group">
					    <label class="control-label col-sm-2" for="email">Email Subject:</label>
					    <div class="col-sm-10">
					      <input type="text"  class="form-control" id="cl_subject" value="<?php if(isset($client)) { echo $client[0]['subject'];} ?>"> 
					    </div>
					  </div>
					  <div class="form-group">
						...
						<div id="toolbar-toolbar" class="toolbar">
						  ...
						  <button class="ql-image"></button>
						    ...
						    <?php if(isset($client)) { echo $client[0]['content'];}else{ ?>
						      	 <h2> Mail body</h2>
						    	  <h4> Mail footer</h4>
						    	  <?php } ?>
						    </div>
						...
						<div class="form-group">
						<p id="updateat">Last update at: <?php if(!empty($client)) { echo $client[0]['updated_at'];} ?></p>
...
<?php include'template/footer.php'; ?>
	...
	$('#cl_upd').click(function(){
		...
		if((cl_subject.length>=4)&&(content.length>=0))
		{
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url();?>services/update_template_client',
					...
					success:function(data){
						...
						if(data!='err')
						{
							...
							$('#res_upd').html('Great!! template updated successfully for client!!').css("color", "green");
					setTimeout(function(){ 
