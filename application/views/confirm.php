...
<html>
	<head>
		<title>Confirmaiton Email</title>
		<style>
		/* reset */
		 ...
		 */
		body{
			background: url(<?php echo base_url();?>assets/images/bg1.png);
	...
	<body>
		...
		<div class="wrap">
				...
				<div class="header">
					<div class="logo">
						<h1><a href="#">Registration Complete</a></h1>
					</div>
				</div>
			
			<div class="content">
				<?php 
				$this->Api_model->checktokan($getparam['hash'], $getparam['u']);
				?>
				<img src="<?php echo base_url();?>assets/images/confirm.png" title="error" />
				<div class="copy-right">
					<p>&#169 All rights Reserved Carwashmi 2017</a></p>
				</div>
   			</div>
		</div>
	</body>
